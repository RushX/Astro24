...
{
    public function K_Id_Verify($V_inter_Name,$V_Inter_OrderId,$Encr_key){
        $hashstr = $V_inter_Name . $V_Inter_OrderId;
    ...
    private $userId = '618785';
    private $apiKey = '7eb2c02ba4c86f0e22ac4d2e87a74902';
    private $language = 'hi';
